...
{{% notice style="warning" title="非表示であって秘密ではありません" %}}
プレゼンターノートは CSS で非表示にされていますが、ページの HTML ソースには**存在しています**。この機能は進行の手がかりやタイミングに使用してください。解答キー、認証情報、または参加者から本当に隠す必要があるものには使用**しないで**ください。
{{% /notice %}}
