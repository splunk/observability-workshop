...
認証エラーが表示される場合は、`.env` の組織アクセストークンとRealmを確認し、再インストールします
...
Collectorの起動後、数分以内にクラスターが表示されます。
...
2〜3分待ちます。CollectorのPodが実行中であることを確認し、ログにエクスポートエラーがないか確認してください。
