...
1. **APM Traceの表示** - APM → Service Map & APM → Traces
2. **RUMセッションの表示** - Digital Experience → Session Search
3. **[オプション] RealmとTokenの詳細の取得** - 注意: これらの値はインスタンスに設定されており、詳細は次のステップで提供されます。
