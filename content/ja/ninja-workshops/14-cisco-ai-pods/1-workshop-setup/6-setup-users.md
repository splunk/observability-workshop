...
このセクションでは、ワークショップ参加者ごとにユーザーを作成し、それぞれに namespace とリソースクォータを設定します。
...
cluster-admin ユーザーを再作成してから、再度ログインします：
...
ローカルマシンからワークショップユーザーの1人としてログインしてみてください：
