...
> [!splunk] **正確な評価。** Splunk Agent Observabilityは、エージェント、出力、RAGの品質を評価するすぐに使えるEvaluatorを提供します。これにより、問題を迅速に発見し、改善を追跡し、エージェントアプリケーションをユーザーにとってより良いものにできます。
