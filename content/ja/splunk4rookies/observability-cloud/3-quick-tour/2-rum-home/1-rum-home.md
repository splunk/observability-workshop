...
- **JavaScript Errors**タイルで、**TypeError**エントリ_Cannot read properties of undefined (reading 'Prcie')_ をクリックして詳細を確認します。ウェブサイトのどの部分でエラーが発生したかを素早く示してくれることに注意してください。これにより、迅速に修正することができます。
- ペインを閉じます。
