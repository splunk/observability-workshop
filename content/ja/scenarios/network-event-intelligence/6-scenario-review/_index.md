...
このワークショップを通じて、Catalyst Center のトポロジーデータを使用して**ロケーションベースのネットワーク可視性**を提供するように ITSI を設定し、**2つの独立した監視ツール**からアラートを取り込んで正規化し、それらのアラートを**サイトごとの単一のアクション可能なエピソード**に相関させるカスタム集約ポリシーを構築しました。
