...
* Para que isso funcione para todos os rastreamentos, remova `trace_id` do filtro e adicione os campos `sf_service=paymentservice` e `sf_environment=[WORKSHOPNAME]`.
