...
{{% exercise title="Abra o intervalo com falha" %}}

* Clique no {{% button style="red"  %}}!{{% /button %}} próximo a qualquer um dos intervalos `paymentservice:grpc.hipstershop.PaymentService/Charge` na cascata.
...
{{% /exercise %}}
Agora que identificamos a versão do **paymentservice** que está causando o problema, vamos ver se conseguimos encontrar mais informações sobre o erro. É aqui que entra **Related Logs**.
...
{{% exercise title="Ir do APM para registros relacionados" %}}
