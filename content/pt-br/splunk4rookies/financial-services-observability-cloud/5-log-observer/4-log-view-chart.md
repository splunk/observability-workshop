...
* Os filtros devem ser os mesmos do exercício anterior, com o seletor de tempo definido como **Last 15 minutes** e filtros para severity=error, `sf_service=wire-transfer-service` e `sf_environment=[WORKSHOPNAME]`.
...
* Na parte superior da página, clique em ***...*** à esquerda do nome do dashboard.
  ![vinculando](../images/linking.png)
* Selecione **Link to teams** no menu suspenso.
