...
> [!IMPORTANT] Using the content related to the **APM** trace (logs) we will now use **Logs** to drill down further to understand exactly what the problem is. Related Content is a powerful feature that allows you to jump from one component to another and is available for **metrics**, **traces** and **logs**.
