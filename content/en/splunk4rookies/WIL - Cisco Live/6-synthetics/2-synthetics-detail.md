...
* In the Video pane, press on the play button **▶** to see the test playback.
* Using the filter above the filmstrip, under the heading **Filter by a synthetic transaction, page, or step**, click on **Place Order** under **Synthetic transactions**.
