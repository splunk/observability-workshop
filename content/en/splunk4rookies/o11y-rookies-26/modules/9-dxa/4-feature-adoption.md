...
1. A time series showing when users interact with a feature helps us understand whether adoption is growing, plateauing, or declining. That informs product investment decisions — whether to improve the feature, change its placement, or revisit the strategy entirely.
...
1. Replay reveals *why* adoption might be lower than expected — for example, users scrolling past the feature, a popup obscuring it, or confusion about how to use the quick prompts. Metrics tell us adoption is low; replay shows us why.
...
Feature adoption tells us what users choose to engage with. Next, let's look at signals that reveal when the experience is going wrong.
