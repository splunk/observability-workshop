...
Log in to Splunk Observability. From the left side menu bar select **RUM** ![RUM-ico](../images/RUM_ico.png?classes=inline&height=25px). This will bring you to your the RUM Landing Page.
