...
THIS CONTENT NEEDS TO BE REVIEWED; FOR NOW REMOVING.
...
1. In ThousandEyes, create an OAuth Bearer token:
    ...
    - Copy or make a note of the token to use in the Observability Cloud data integration wizard. You won't be able to get this token again (and will need to revoke/create again).
1. In Splunk Observability Cloud, open **Data Management > Available Integrations > ThousandEyes Network Insights**
    - Select an **Ingest** token.
    - Enter your OAuth bearer token from ThousandEyes
