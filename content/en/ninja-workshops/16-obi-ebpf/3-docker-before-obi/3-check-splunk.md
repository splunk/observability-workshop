...
1. Open [Metric Finder](https://app.us1.signalfx.com/#/metrics) (or [make a chart](https://app.us1.signalfx.com/#/chart/new?template=default&filters=sf_metric%3Aworkshop_heartbeat)) and search for `workshop_heartbeat`
