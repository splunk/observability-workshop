...
This phase takes the exact same "naked" application code from Phase 2 and deploys it to Kubernetes. The OBI agent runs as a DaemonSet instead of a standalone container, instrumenting every pod on every node.
