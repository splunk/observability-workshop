...
The first thing we'll need to do is create an account with Red Hat, which we can do by [filling out the form](https://www.redhat.com/wapps/ugc/register.html?_flowId=register-flow&_flowExecutionKey=e1s1).
...
> [!NOTE]
> Update the region as appropriate for your environment.
...
> [!NOTE]
> By default, each AWS region is limited to 5 elastic IP addresses.  
...
> [!IMPORTANT]
> Make note of the oidc-provider id that is created.
