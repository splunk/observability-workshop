...
In this phase you'll deploy a polyglot (that word again!) microservices stack and establish the "before" state: infrastructure metrics flow to Splunk, but APM has zero traces because the applications have absolutely no instrumentation.
