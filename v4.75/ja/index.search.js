...
\u003cstrong\u003eMute Indefinitely\u003c/strong\u003e をクリックして、設定を確定させます。
...
\u003cstrong\u003eResume\u003c/strong\u003e をクリックして、このディテクターの通知を確認し、再開します。
...
新しいチームを追加するには、 \u003cstrong\u003eCreate New Team\u003c/strong\u003e ボタンをクリックします。これにより、Create New Team ダイアログが表示されます。
...
自分のイニシャルでグループを作成し、自分がメンバーとして追加されていることを確認して、 \u003cstrong\u003eDone\u003c/strong\u003e をクリックします。
...
3.1 受信者の追加 \u003cstrong\u003eAdd Recipient\u003c/strong\u003e をクリックすると、他の受信者を追加することができます。これらの受信者は Observability Cloud のユーザーである必要はありません。
...
ダッシュボードが選択されていることを確認して、 \u003cstrong\u003eOk\u003c/strong\u003e ボタンを押します。
...
\u003cstrong\u003e+\u003c/strong\u003e を押し、 Add Dashboard Group ボタンを押して、チームページにダッシュボードを追加します。
...
2. 新しいトークンの作成 \u003cstrong\u003eNew Token\u003c/strong\u003e ボタンをクリックして、新しいトークンを作成しましょう。Name Your Access Token ダイアログが表示されます。
ここでは、Ingest Token と API Token の両方のチェックボックスにチェックを入れてください。
\u003cstrong\u003eOK\u003c/strong\u003e を押すと、Access Token のUIに戻ります。ここでは、既存のトークンの中に、あなたの新しいトークンが表示されているはずです。
...
受信者を指定するには、 \u003cstrong\u003eAdd Recipient\u003c/strong\u003e をクリックして、使用する受信者または通知方法を選択します（受信者の指定は任意ですが、強くお勧めします）。
トークンアラートの重要度は常に「Critical」です。
\u003cstrong\u003eUpdate\u003c/strong\u003e をクリックすると、アクセストークンの制限とアラートの設定が保存されます。
...
UIの右上にある + アイコンを選択し、ドロップダウンから Chart を選択します。 または、 \u003cul\u003e \u003cli\u003eNew Chart\u003c/li\u003e \u003c/ul\u003e ボタンをクリックすると、新しいチャートが作成されます。
...
`,description:"",tags:null,title:"さらなるワークショップ",uri:"/ja/other/index.html"},{content:"",description:"",tags:null,title:"Categories",uri:"/ja/categories/index.html"},{content:"",description:"",tags:null,title:"Tags",uri:"/ja/tags/index.html"}]