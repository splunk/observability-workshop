...
LEO LEO Hover over _**DASHBOARDS**_ in the top menu, and then click on _**All DashboardsLEO**_. A number of prebuilt dashboards are provided for you in your default view.
