...
![User Detail](../images/module7/m7-user-detail.png){: .center}
...
![Timeline Filters Message Types](../images/module7/m7-timeline-filters-message-types.png)
...
![On Duty](../images/module7/m7-on-duty.png){: .center}
...
![Push Notification](../images/module7/m7-push-notification.png){: .center}
...
![UI Annotations](../images/module7/m7-ui-annotations.png){: .center}

On your phone click the `Chart Showing Alert` link...

![Phone Link](../images/module7/m7-phone-image-link.png){: .center}

...and you should now get the exact same image on your phone.

![Phone Annotation](../images/module7/m7-phone-annotation.png){: .center}
...
![Quick Access](../images/module7/m7-quick-access.png){: .center}
...
![Add Message](../images/module7/m7-rogue-process-message.png){: .center}
...
![Resolved](../images/module7/m7-resolved.png){: .center .zoom}
