...
​ Helm Install Helm Install Output Install Network Explorer helm install splunk-otel-collector \\ --set="splunkObservability.realm=$REALM" \\ --set="splunkObservability.accessToken=$ACCESS_TOKEN" \\ --set="clusterName=$(hostname)-k3s-cluster" \\ --set="splunkObservability.logsEnabled=true" \\ --set="splunkObservability.profilingEnabled=true" \\ --set="splunkObservability.infrastructureMonitoringEventsEnabled=true" \\ --set="environment=$(hostname)-workshop" \\ splunk-otel-collector-chart/splunk-otel-collector \\ -f ~/workshop/k3s/otel-collector.yaml Using ACCESS_TOKEN={REDACTED} Using REALM=eu0 NAME: splunk-otel-collector LAST DEPLOYED: Fri May 7 11:19:01 2021 NAMESPACE: default STATUS: deployed REVISION: 1 TEST SUITE: None
helm install splunk-otel-collector \\ --set="splunkObservability.realm=$REALM" \\ --set="splunkObservability.accessToken=$ACCESS_TOKEN" \\ --set="clusterName=$(hostname)-k3s-cluster" \\ --set="splunkObservability.logsEnabled=true" \\ --set="splunkObservability.infrastructureMonitoringEventsEnabled=true" \\ --set="networkExplorer.enabled=true" \\ --set="networkExplorer.podSecurityPolicy.enabled=false" \\ --set="agent.enabled=true" \\ --set="gateway.replicaCount=1" \\ --set="gateway.resources.limits.cpu=500m" \\ --set="gateway.resources.limits.memory=1Gi" \\ --set="clusterReceiver.enabled=true" \\ --set="environment=$(hostname)-workshop" \\ splunk-otel-collector-chart/splunk-otel-collector \\ -f ~/workshop/k3s/otel-collector.yaml 約30秒程度待ってから kubectl get pods を実行すると、新しいポッドが稼働していることが報告され、デプロイメントの進捗を監視することができます。
...
`,description:"",tags:null,title:"さらなるワークショップ",uri:"/ja/other/index.html"},{breadcrumb:"Splunk Observability Workshops",content:"",description:"",tags:null,title:"Categories",uri:"/ja/categories/index.html"},{breadcrumb:"Splunk Observability Workshops",content:"",description:"",tags:null,title:"Tags",uri:"/ja/tags/index.html"}]