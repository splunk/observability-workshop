...
#
# We will use 5-redeploy-creditprocessorservice.sh to update the app.
...
echo ""
echo You will use 5-redeploy-creditprocessorservice.sh after making any changes to redeploy the service.