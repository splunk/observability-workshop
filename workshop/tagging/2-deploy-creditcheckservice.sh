...
#
# We will use 4-redeploy-creditcheckservice.sh to update the app.
...
echo ""
echo You will use 4-redeploy-creditcheckservice.sh after making any changes to redeploy the service.