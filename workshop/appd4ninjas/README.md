...
- Navigate to Tomcat manager, e.g. http://[address]:8443/
- Click Manager App 
...
After this it would be advised to remove the admin user, and even change the foldername of the manager, from:
...
# Change it to use port 8443 (or whichever port is correct) 
