...
-- Add warehouses
INSERT INTO warehouses (warehouse_name, address_line1, city, state, postal_code, country)
VALUES
    ('Seattle Distribution Center', '123 Coffee Ave', 'Seattle', 'WA', '98101', 'USA'),
    ('Dallas Fulfillment Hub', '456 Roast Rd', 'Dallas', 'TX', '75201', 'USA'),
    ('Atlanta Storage Depot', '789 Brew Blvd', 'Atlanta', 'GA', '30303', 'USA');
